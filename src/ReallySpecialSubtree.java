 ...
 */
public final class ReallySpecialSubtree {

    private final int V;
    private final int E;
    private final Graph graph;

    public ReallySpecialSubtree(int v, int e) {
        V = v;
        E = e;
    ...
    private static final class Edge implements Comparable<Edge> {
        ...
        public int compareTo(Edge compareEdge) {
            if (weight == compareEdge.weight) {
                int x = src + weight + dest;
                int y = compareEdge.src + compareEdge.weight + compareEdge.dest;
                return x - y;
            }
    ...
    public int mstWeight() {
        ...
        while (e < V - 1) {
            ...
            if (x != y) {
                result[e++] = next_edge;
                overallWeight += next_edge.weight;
